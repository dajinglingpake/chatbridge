    ...
    def _invoke_backend(self, agent: AgentConfig, task: HubTask) -> dict[str, str]:
        ...
        return backend.invoke(
            ...
            context=BackendContext(
                ...
                permission_profile=task.permission_profile.strip(),
            ...
            return IpcResponseEnvelope(
                ...
                payload={
                    "task": self.submit_task(
                        ...
                        str(payload.get("permission_profile") or ""),
                        [str(item).strip() for item in (payload.get("images") or []) if str(item).strip()] if isinstance(payload.get("images"), list) else [],
