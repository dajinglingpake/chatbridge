...
ONEBOT_RUNTIME_DIR = RUNTIME_DIR / "onebot-runtime"
...
QQ_BRIDGE_PID_FILE = RUNTIME_DIR / "qq_onebot_bridge.pid"
ONEBOT_RUNTIME_PID_FILE = RUNTIME_DIR / "qq_onebot_runtime.pid"
...
QQ_BRIDGE_OUT_LOG = LOG_DIR / "qq_onebot_bridge.out.log"
QQ_BRIDGE_ERR_LOG = LOG_DIR / "qq_onebot_bridge.err.log"
ONEBOT_RUNTIME_OUT_LOG = LOG_DIR / "qq_onebot_runtime.out.log"
ONEBOT_RUNTIME_ERR_LOG = LOG_DIR / "qq_onebot_runtime.err.log"
APP_SERVICE_OUT_LOG = LOG_DIR / "app_service.out.log"
APP_SERVICE_ERR_LOG = LOG_DIR / "app_service.err.log"
...
BRIDGE_RESTART_NOTICE_PATH = _resolve_path_override("CHATBRIDGE_BRIDGE_RESTART_NOTICE_PATH", STATE_DIR / "weixin_restart_notice.json")
SERVICE_ACTION_STATE_PATH = _resolve_path_override("CHATBRIDGE_SERVICE_ACTION_STATE_PATH", STATE_DIR / "service_action_state.json")
SERVICE_ACTION_LOG_PATH = _resolve_path_override("CHATBRIDGE_SERVICE_ACTION_LOG_PATH", LOG_DIR / "service_action_log.jsonl")
